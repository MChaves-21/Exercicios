...
function listarVagas() {
    const vagasEmTexto = vagas.reduce((textoFinal, vaga, indice) => {//texto final e o valor que vai acumulando a cada loop,vaga e a vaga atual do loop,indice e o indice da vaga atual
      textoFinal += indice + ". "
  ...
  function exibirVaga() {
    ...
    if(indice>=vagas.length || indice<0){
        ...
        return//esse return vai funcionar de forma semelhante a um break
      }
    const vaga = vagas[indice]
    //em vaga.candidato ele esta referenciando o array candidato dentro do objeto vaga
    const candidatosEmTexto = vaga.candidatos.reduce((textoFinal, candidato) => textoFinal + "\n - " + candidato, "")//para cada candidato vai pular uma linha adicionar - e um candidato
